...
#         pool = mp.Pool()
#         x=pool.apply_async(mod_1, args=(audio_path,model,), callback=log_result).get()
#         # pool.apply_async(mod_2, args=(sooraj_model1, sooraj_model1,), callback=log_result)
#         pool.close()
#         pool.join()
#         return x
#
#
#     re=apply_async_with_callback()
#     # result_list = []
#     #
#     # def log_result(result):
#     #     result_list.append(result)
...
#     # pool.apply_async(mod_1, args=(audio_path,model), callback=log_result)
#     # pool.apply_async(mod_2, args=(sooraj_model1, sooraj_model1), callback=log_result)
#     # # pool.apply_async(a2, args=(3,), callback=log_result)
#     # # pool.close()
#     # pool.join()
#     return re
